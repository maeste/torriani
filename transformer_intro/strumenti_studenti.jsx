...
const NOTEBOOK_STEPS = [
  { emoji: "📚", label: "Carica i tuoi appunti/PDF", detail: "Carica fino a 50 fonti: appunti, PDF, slide, pagine web. NotebookLM indicizza tutto." },
  { emoji: "🤖", label: "L'IA li analizza e comprende", detail: "L'IA legge e comprende il contenuto usando RAG (Retrieval Augmented Generation). Non inventa: cerca solo nei TUOI documenti." },
  { emoji: "🎯", label: "Scegli il formato di output", detail: "Clicca su uno dei formati qui sotto per vedere cosa puoi ottenere." },
];

const NOTEBOOK_OUTPUTS = [
  { emoji: "📝", label: "Riassunto", color: COLORS.accent, description: "Genera riassunti strutturati dei tuoi appunti, evidenziando i concetti chiave e le relazioni tra gli argomenti. Perfetto prima di un esame." },
  { emoji: "❓", label: "Quiz", color: COLORS.accent2, description: "Crea domande a risposta multipla e aperte basate SOLO sui tuoi materiali. Ideale per testare la tua preparazione." },
  { emoji: "🎧", label: "Podcast", color: COLORS.accent3, description: "Trasforma i tuoi appunti in una conversazione audio tra due conduttori che discutono gli argomenti. Perfetto per ripassare in autobus!" },
  { emoji: "❔", label: "Domande", color: COLORS.accent4, description: "Genera domande di comprensione profonda per verificare se hai davvero capito i concetti, non solo memorizzato." },
];

/* ── Tutor Mode Data ───────────────────────────────────── */

const TUTOR_PROMPTS = [
  { text: "Non darmi la risposta, guidami passo per passo", emoji: "🧭" },
  { text: "Fammi domande per verificare se ho capito", emoji: "❓" },
  { text: "Spiegami come se avessi 15 anni", emoji: "💡" },
  { text: "Dammi un'analogia dalla vita quotidiana", emoji: "🔍" },
  { text: "Quali errori fanno spesso gli studenti su questo?", emoji: "⚠️" },
];
...
const TUTOR_ITEMS = [
  { text: "Chiedere spiegazioni", emoji: "📖" },
  { text: "Farsi guidare passo per passo", emoji: "🧭" },
  { text: "Verificare la propria comprensione", emoji: "✅" },
  { text: "Imparare il metodo di studio", emoji: "💡" },
  { text: "Riformulare con parole proprie", emoji: "✍️" },
];

const GHOST_ITEMS = [
  { text: "Copiare risposte", emoji: "❌" },
  { text: "Generare temi e saggi", emoji: "🚫" },
  { text: "Far fare i compiti all'IA", emoji: "🙅" },
  { text: "Zero apprendimento reale", emoji: "💭" },
  { text: "Dipendenza dallo strumento", emoji: "⛓️" },
];
          ...
          {["normale", "tutor"].map((mode) => (
            ...
            >
              <div style={{
                ...
                {mode === "normale" ? "💬 Modalità Normale" : "🎓 Modalità Tutor"}
              </div>
            </button>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}>
            <div style={{
              ...
              <div style={{ color: COLORS.muted, fontSize: 11, marginBottom: 4 }}>{"🧑‍🎓"} Studente</div>
          ...
          <div style={{ display: "flex", justifyContent: "flex-start" }}>
            <div style={{
              ...
              <div style={{ color: COLORS.muted, fontSize: 11, marginBottom: 4 }}>{"🤖"} IA</div>
              {tutorMode === "normale" ? (
                ...
                <div style={{ color: COLORS.text, fontSize: 14, lineHeight: 1.6 }}>
                  ...
                  <br />
                  {"🤔"} Cosa sai gi&agrave; della Francia? Quale citt&agrave; &egrave; famosa per la Torre Eiffel?
                  <br />
                  {"💡"} Pensa anche: qual &egrave; la citt&agrave; francese pi&ugrave; grande e sede del governo?
                </div>
              )}
            </div>
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {"🚨"} PERCHÉ COPIARE CON L&apos;IA È PEGGIO CHE COPIARE SENZA
          </div>
        ...
        <div style={{
          ...
          <div style={{ color: COLORS.muted, fontSize: 11, fontFamily: "'JetBrains Mono', monospace", letterSpacing: 1, marginBottom: 10 }}>
            {"🛡️"} STRUMENTI ANTI-PLAGIO IA IN USO NELLE SCUOLE
          </div>
